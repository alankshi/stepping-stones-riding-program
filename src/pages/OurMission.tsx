            ...
            >
                <div className="mission-video-container">
                    <video
                        ...
                        autoPlay
                        muted
                        className="mission-video-background"
                    >
                ...
                <div className="mission-text-container">
                    ...
                    <p className="mission-text">
                        Our mission at Stepping Stones is to connect horses and
                        people regardless of circumstance and wealth with
                        low-cost riding lessons and horse experiences
                    </p>
                </div>
            </div>
        );
